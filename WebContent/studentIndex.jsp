...
<%@page import="com.service.CourseService"%>
<%@page import="com.bean.CoursesBean"%>
...
ArrayList<CoursesBean> li = new ArrayList<>();
				...
				<div class="row d-flex justify-content-between">
					...
					<div class="topbar-right">
						<ul>
							...
							<li><%= sb.getFname() %></li>
							<li><a href='LogoutController?action=studentlogout'>Logout</a></li>
						</ul>
					</div>
				</div>
			</div>
                        ...
                        <ul class="nav navbar-nav">	
							...
							<li class="nav-dashboard"><a href="javascript:;">Dashboard <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									...
									<li><a href="admin/viewTechnologiesStudent.jsp">View Technologies</a></li>
									<li><a href="admin/viewTeachersStudent.jsp">View Teachers</a></li>
									<li><a href="admin/viewCoursesStudent.jsp">Courses</a></li>
									<li><a href="admin/addReviewStudent.jsp">Add Review</a></li>
									<li><a href="admin/studentProfile.jsp">User Profile</a></li>
								</ul>
							</li>
						</ul>
                    </div>
...
ArrayList<ReviewBean> rlist = rs.getReview();
						...
						<div class="item">
							<div class="testimonial-bx">
								...
								<div class="testimonial-info">
									<h5 class="name"><%= rb.getStudentName() %></h5>
									<p><%= rb.getStudentCourse() %></p>
								</div>
