					...
					<div class="widget-box">
						<div class="email-wrapper">
							...
							<div class="mail-list-container">
								<form class="mail-compose" action="../EmailController" method="post">
									<div class="form-group col-12">
										<input class="form-control" type="email" name="to" placeholder="To">
									</div>
									<div class="form-group col-12">
										<input class="form-control" type="email" name="cc" placeholder="CC">
									</div>
									<div class="form-group col-12">
									...
									<div class="form-group col-12">
										<!-- <div class="summernote"> -->
											<textarea rows="10" cols="80" name="message" placeholder="Type here..."></textarea>
										<!-- </div> -->
									</div>
									<div class="form-group col-12">
									...
									<div class="form-group col-12">
										<button type="submit" class="btn btn-lg" name="action" value="Send">Send</button>
									</div>
								</form>
							</div>
						</div>
