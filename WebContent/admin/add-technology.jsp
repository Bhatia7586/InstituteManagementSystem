	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">Add Technology</h4>
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" action="../TechController" method="post">
								<div class="row">
									<div class="col-12"> 
										<div class="ml-auto">
											<h3>1. Basic info</h3>
								...
								<!-- 
								 ...
								 -->
									...
									<div class="form-group col-12">
										<label class="col-form-label">Technology description</label>
										<div>
						...
						<!-- 			<div class="col-12 m-t20">
						 ...
						 -->
									<div class="col-12">
										<button type="submit" name="action" value="Add Technology" class="btn-secondry add-item m-r5"><i class="fa fa-fw fa-plus-circle"></i>Add Technology</button>
