				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" action="../TrainerController" method="post">
								<div class="row">
									<div class="col-12"> 
										<div class="ml-auto">
											<h3>1. Basic info</h3>
									...
									<div class="form-group col-6">
										...
										<div>
											<%
												...
												{
											%>
											<input type="checkbox" name="t_technology" value="<%= t.getTechId()%>"><%=t.getT_name() %>
											<% 		
												}
											%>
										</div>
						...
						<!-- 			<div class="form-group col-6">
							 ...
							 -->
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" type="text" name="t_fname">
										</div>
									</div>
									<div class="form-group col-6">
										<label class="col-form-label">Last name</label>
										<div>
											<input class="form-control" type="text" name="t_lname">
										</div>
									</div>
									<div class="form-group col-6">
										<label class="col-form-label">Email</label>
										<div>
											<input class="form-control" type="text" name="t_email">
										</div>
									</div>
									<div class="form-group col-6">
										<label class="col-form-label">Qualification</label>
										<div>
											<input class="form-control" type="text" name="t_quali">
										</div>
									</div>
									...
									<div class="form-group col-12">
										<label class="col-form-label">Teacher Experience</label>
										<div>
											<textarea class="form-control" name="t_exp"> </textarea>
										</div>
									</div>
						<!-- 			<div class="col-12 m-t20">
										<div class="ml-auto">
						 ...
						 -->
									<div class="col-12">
										<button type="submit" name="action" value="Add Teacher" class="btn-secondry add-item m-r5"><i class="fa fa-fw fa-plus-circle"></i>Add Teacher</button>
