			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
		                ...
		                <ul>
		                	<li>
		                		<a href="adminProfile.jsp" class="ttr-material-button"><span class="ttr-label">Admin Profile</span></a>
		                	</li>
		                </ul>
		            </li>
							...
							<form class="edit-profile m-b30">
								<div class="">
									...
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control" type="text" value="<%= ab.getA_name()%>">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Occupation</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" value="<%= ab.getA_uname()%>">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Company Name</label>
										<div class="col-sm-7">
											<input class="form-control" type="text" value="Institute Managment System">
							...
							<form class="edit-profile">
								<div class="">
									...
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control" type="password" value="<%= ab.getA_password()%>">
										</div>
									</div>
									<div class="form-group row">
